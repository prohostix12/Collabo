  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-1">
        {kycStep > 1 && (
          <button onClick={()=>{setKycError('');setKycStep(s=>s-1)}} className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg text-[11px] font-medium hover:bg-gray-200 transition-colors flex items-center gap-1">
