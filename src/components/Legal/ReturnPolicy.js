...
const ReturnPolicy = () => {
  // SEO meta tags
  useEffect(() => {
    document.title = "Return & Refund Policy - Collabo";
    const meta = document.createElement('meta');
    meta.name = "description";
    meta.content = "Collabo's return and refund policy detailing return windows, procedures, and contact information.";
